...
- I'm getting a `Microdrive not present, 0:1` message
  - Microdrives & Interface 1s are getting old now so make sure the edge connectors are clean. Use some Isopropyl (Rubbing) alchohol to clean the connector on the IF1 (left hand side). Also check the connectors are fully plugged in.
