...
## Version History
- v1.12t (latest release) - Some users have reported some bad sectors during write operations (save, format). This version optimse the record code, tightening the timings to improve this. Also disables the Scmitt triggers on the data I/O pins which improves data input delay. *Note this is still in test.
