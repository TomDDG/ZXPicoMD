...
In addition I've also uploaded a IF1 ROM test cartridge which determines the ROM version of the IF1 which was useful for degbugging as I've only been able to test ZX PicoMD with a v2 ROM which fixed a few bugs present in the v1 ROM (https://github.com/TomDDG/ZXPicoMD/blob/main/TestCarts/IF1ROM.mdr).
